--
-- Dynamic Omuntu Theme Menu for Elephant/Walker
--
Name = "omuntuthemes"
NamePretty = "Omuntu Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/omuntu/themes"
  local omuntu_path = os.getenv("OMUNTU_PATH") or ""
  local default_theme_dir = omuntu_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "omuntu-theme-set " .. theme_name,
            },
          })
        end
      end
