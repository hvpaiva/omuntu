Name = "omuntuBackgroundSelector"
NamePretty = "Omuntu Background Selector"
Cache = false
...
function GetEntries()
  ...
  local theme_name_file = io.open(home .. "/.config/omuntu/current/theme.name", "r")
  ...
  local dirs = {
    home .. "/.config/omuntu/current/theme/backgrounds",
  }
  if theme_name then
    table.insert(dirs, home .. "/.config/omuntu/backgrounds/" .. theme_name)
  end
